...
Terminal command to run this file from the root project folder:
    ...
    uv run python -m streaming.consumer_Asher
...
DEFAULT_TOPIC_NAME: Final[str] = "missing-env-copy-env-example-Asher"
DEFAULT_MAX_MESSAGES: Final[str] = "10"
DEFAULT_POLL_INTERVAL_SECONDS: Final[str] = "1.0"
DEFAULT_TIMEOUT_SECONDS: Final[str] = "10.0"
