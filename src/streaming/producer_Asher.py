...
Terminal command to run this file from the root project folder:
    ...
    uv run python -m streaming.producer_Asher
...
DEFAULT_TOPIC_NAME: Final[str] = "streaming-01-topic-no-env-Asher"
DEFAULT_MESSAGE_COUNT: Final[str] = "10"
DEFAULT_MESSAGE_INTERVAL_SECONDS: Final[str] = "1.0"
